...
public class CatelogyController {
    ...
    @PostMapping("/edit")
    public ModelAndView updateCustomer(@ModelAttribute("catelogy") Catelogy catelogy) {
        iCatelogyService.save(catelogy);
        ModelAndView modelAndView = new ModelAndView("catelogy/edit");
        modelAndView.addObject("catelogy", catelogy);
    ...
    @PostMapping("/delete")
    public String deleteCustomer(@ModelAttribute("catelogy") Catelogy catelogy, RedirectAttributes attributes) {
